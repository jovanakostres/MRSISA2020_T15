...
public class AuthorizationController {
	...
	public ResponseEntity register(@RequestBody ZahtevZaRegistraciju pacijent) {
		...
		try {
			...
			if (pacijentService.findByEmail(pacijent.getEmail()) != null) {
				...
				ZahtevZaRegistraciju zahtev = new ZahtevZaRegistraciju(pacijent.getEmail(), pacijent.getLozinka(),
						pacijent.getIme(), pacijent.getPrezime(), pacijent.getAdresa(), pacijent.getBroj(),
						pacijent.getLbo());
	...
	public ResponseEntity confirmUserAccount(@RequestBody ZahtevZaRegistracijuDto zahtevDto) {
		try {
			...
			Pacijent pacijent = new Pacijent(zahtev.getEmail(), zahtev.getLozinka(), zahtev.getIme(),
					zahtev.getPrezime(), zahtev.getAdresa(), zahtev.getBroj(), zahtev.getLbo());
