...
insert into korisnici (id,email, lozinka, ime, prezime, adresa, broj, type, promena_lozinke) values (8,'peraperisic@gmail.com','$2y$10$36aBCJZ3FP0tvemsTOLGAuznxAqP2AC9Eap4IWgrPrvRAukwgKUBO','Pera', 'Perisic','Adresa 8','0600000007','AK','false');
...
update korisnici set ak_id = 1 where id = 6;
update korisnici set ak_id = 2 where id = 8;
...
insert into pregledi (id, datum, vreme_od, vreme_do, cena, tip_pregleda_id,izvrsen, definisan,operacija) values (1, '2020.06.07','10:00','11:00',5000, 1, 'false', 'true','false');
